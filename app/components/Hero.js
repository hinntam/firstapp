...
const Hero = () => (
    <section className="pb-4 lg:mb-35 items-center justify-center text-center max-w-7xl mx-auto px-4">
      ...
      <div className="flex flex-wrap">
        ...
        <div className="flex flex-col items-center lg:items-start">
         ...
         >Software Developer / Web Dev
          ...
          <p class="my-2 max-w-xl py-6 font-light tracking-tighter" 
          >
            Hello! I’m passionate developer based in Calgary, Canada, 
          currently pursuing a Software Development Diploma at the Southern Alberta Institute
          of Technology (SAIT). I have gained valuable experience working on a variety of 
          projects that span both backend and frontend technologies. My diverse skill set 
          allows me to tackle challenges effectively and contribute to innovative solutions.
            I’m excited to continue growing my expertise and making an impact in the tech 
            community.
            
          </p>
          <div className="mr-6 flex flex-wrap items-center">
            <span className="text-neutral-100 tracking-wide font-light h-full w-full block relative linear-mask hover:bg-indigo-400">
                  <div class="flex flex-row items-center justify-center">Download CV 
                  ...
                  <span class="block absolute inset-0 rounded-full p-px linear-overlay"></span>
